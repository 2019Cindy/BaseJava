package com.yy.session.control;

import com.yy.session.entry.User;
import com.yy.session.service.impl.UserServiceImpl;
...
//            resp.getWriter().write("failure!");
             ...
             */
            req.getRequestDispatcher("sessionPage").forward(req,resp);
            // 转发后，后续不再处理相关逻辑
            return;
        }else{
...
//            req.getRequestDispatcher("hello").forward(req, resp);
             ...
             */
            resp.sendRedirect("sessionHello");
        }
    }
